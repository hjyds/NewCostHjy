...
window.GetPartMethodUrl = function (type) {
    ...
    pageid = "cc29e4a0-ed4b-4a72-8630-8c6fbc743876";  //放射项目部位设置_编辑 页面
    item_id = $(`div[data-id="com_i9ixrevzu8"] zl-container zl-qmlist`)[0]?.GetCurrentData()?.resource_detail_id || "";
    class_id = $(`div[data-id="com_8c5mxne1p9q"] zl-container zl-qmlist`)[0]?.GetCurrentData()?.detail_name || "";
    editsta = type;
...
window.GetSyncData = function () {
    ...
    let temp = $(`div[data-id="com_i9ixrevzu8"] zl-container zl-qmlist`)[0]?.GetCurrentData();
    let serviceCode = "X_MD_0026";

    let bData = temp;
    debugger
    bData = {
        "study_type_code": temp["01a056df-50b7-72f0-9113-a55cccbecd4f"],//检查类型编码
        "study_type_name": temp["01a056df-50b7-72f0-9113-a55cccbecd4f"],//检查类型名称
        "part_code": temp["01a056df-50ac-73dc-a477-a8379735fff7"],//部位编码
        "part_name": temp["01a056df-50b5-7a67-80eb-6a4a0afd9ccd"],//部位名称
        "part_group_code": temp["01a056df-509c-7b08-aa85-6775ef2fa02e"],//分组名称
        "part_group_name": temp["01a056df-509c-7b08-aa85-6775ef2fa02e"],//分组名称
        "part_method": [],
        "state": -1
    };
...
window.DeletePartData = function () {
    let curData = $(`div[data-id="com_i9ixrevzu8"] zl-container zl-qmlist`)[0]?.GetCurrentData()
    debugger
    var parData = {}
    parData.功能 = 3;
    parData.操作 = 3;
    parData.类型 = curData["01a056df-50b7-72f0-9113-a55cccbecd4f"];
    parData.原编码 = curData["01a056df-50ac-73dc-a477-a8379735fff7"];
    parData.是否新放射 = 0;
