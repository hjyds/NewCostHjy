...
window._界面控件 = {
    ...
    _编码选项: {
        _收费方式采集: "0|0-正常收取,1|1-检验试管费用,2|2-一次发送只收取一次,3|3-当天只收取一次,4|4-当天未执行收取一次,5|5-当天只收取一次,排斥其他项目,6|6-当天未执行收取一次,排斥其他项目,7|7-每天首次不收取,8|8-按收费方案收取,9|9-自定义",
        _收费方式: "0|0-正常收取,2|2-一次发送只收取一次,3|3-当天只收取一次,4|4-当天未执行收取一次,5|5-当天只收取一次,排斥其他项目,6|6-当天未执行收取一次,排斥其他项目,7|7-每天首次不收取,8|8-按收费方案收取,9|9-自定义",
