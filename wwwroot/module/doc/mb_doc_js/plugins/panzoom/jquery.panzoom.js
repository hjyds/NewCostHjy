...
(function (global, factory) {
	...
	function createResetOptions(opts) {
		console.log("createResetOptions");
	...
	Panzoom.prototype = {
		...
		_startMove: function (event, touches) {
			...
			var panOptions = { matrix: matrix, animate: 'skip', contain: 'invert' };
			...
			if (touches && touches.length === 2) {
				...
				var startScalee = +matrix[0];  // 当前放大的比例 不放大时为1
				if (startScalee > 1) {
					...
					move = function (e) {
						//console.log("555elsepreventDefault");
						e.preventDefault();
						self.pan(
