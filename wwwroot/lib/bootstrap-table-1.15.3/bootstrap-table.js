(function (global, factory) {
    ...
    */
    ...
    //20220827byZT：开放fitHeader命令，用于刷新固定列头
    var METHODS = ['getOptions', 'refreshOptions', 'getData', 'getSelections', 'load', 'append', 'prepend', 'remove', 'removeAll', 'insertRow', 'updateRow', 'getRowByUniqueId', 'updateByUniqueId', 'removeByUniqueId', 'getRowByIndex', 'removeByIndex', 'updateCell', 'updateCellByUniqueId', 'fitHeader', 'showRow', 'hideRow', 'getHiddenRows', 'showColumn', 'hideColumn', 'getVisibleColumns', 'getHiddenColumns', 'showAllColumns', 'hideAllColumns', 'mergeCells', 'checkAll', 'uncheckAll', 'checkInvert', 'check', 'uncheck', 'checkBy', 'uncheckBy', 'refresh', 'destroy', 'resetView', 'showLoading', 'hideLoading', 'togglePagination', 'toggleFullscreen', 'toggleView', 'resetSearch', 'filterBy', 'scrollTo', 'getScrollPosition', 'selectPage', 'prevPage', 'nextPage', 'toggleDetailView', 'expandRow', 'collapseRow', 'expandRowByUniqueId', 'collapseRowByUniqueId', 'expandAllRows', 'collapseAllRows', 'updateColumnTitle', 'updateFormatText'];
    var EVENTS = {
        'all.bs.table': 'onAll',
    ...
    var BootstrapTable = /*#__PURE__*/function () {
        ...
        _createClass(BootstrapTable, [{
            ...
            value: function fitHeader(dontSetBody) {
                var _this14 = this;
                ...
                //20220827byZT：开放fitHeader命令，可指定不处理表体
                this.trigger('post-header', dontSetBody);
            }
        }, {
            key: "initFooter",
